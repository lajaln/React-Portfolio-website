...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "naserence@gmail.com",
        href: "mailto:naserence@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+63-9675880758",
        href: "tel:+63-9675880758",
    },
    {
        icon: MapPin,
        label: "Location",
                ...
                <div className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:-primary focus:ring-1 focus:ring-primary outline-none transition-all"/>
                        </div>
                        <div>
                            <label 
                            htmlFor="email"
                        ...
                        <div>
                            ...
                            className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none" >
                            </textarea>
                        </div>

                        <Button className="w-full" type="submit" size="lg" disabled={isLoading}>
                            
                            {isLoading ? (<>sending...</>) : (<> Send Message <Send className="w-5 h-5" /> </>)} </Button>
